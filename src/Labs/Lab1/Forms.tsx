    ...
    return (
        <div id="wd-forms">
            ...
            <form id="wd-text-fields">
                ...
                <input id="wd-text-fields-last-name" type="text" placeholder="Doe" value="Wonderland" title="The last name" />
                ...
                <input id="wd-text-fields-email" type="email" placeholder="jdoe@somewhere.com"/><br/>

                <label htmlFor="wd-text-fields-salary-start">Starting salary:</label>
                <input id="wd-text-fields-salary-start" type="number" placeholder="1000" value="100000"/><br/>
