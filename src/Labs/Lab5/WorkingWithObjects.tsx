    ...
    return (
        <div id="wd-working-with-objects">
            ...
            <input type="checkbox" className="form-check-input" id="wd-assignment-completed"
                value={assignment.completed.toString()} onChange={(e) =>
                setAssignment({ ...assignment, completed: e.target.checked })}/>
            <span className="ms-2">{assignment.completed.toString()}</span>
            <hr />
            ...
            <input className="form-control w-75" id="wd-assignment-name"
            ...
            <br /> <br />
            <h4>Retrieving Module Desctiption</h4>
